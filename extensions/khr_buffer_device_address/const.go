...
const (
	...
	BufferCreateDeviceAddressCaptureReplay common.BufferCreateFlags = C.VK_BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR

	BufferUsageShaderDeviceAddress common.BufferUsages = C.VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT_KHR
