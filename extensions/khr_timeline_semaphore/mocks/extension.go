...
func (m *MockExtension) SemaphoreCounterValue(device core1_0.Device, semaphore core1_0.Semaphore) (uint64, common.VkResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SemaphoreCounterValue", device, semaphore)
	ret0, _ := ret[0].(uint64)
...
func (mr *MockExtensionMockRecorder) SemaphoreCounterValue(device, semaphore interface{}) *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SemaphoreCounterValue", reflect.TypeOf((*MockExtension)(nil).SemaphoreCounterValue), device, semaphore)
}
