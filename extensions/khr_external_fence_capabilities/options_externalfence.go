...
type PhysicalDeviceExternalFenceOptions struct {
	HandleType ExternalFenceHandleTypes

	common.HaveNext
}

func (o PhysicalDeviceExternalFenceOptions) PopulateCPointer(allocator *cgoparam.Allocator, preallocatedPointer unsafe.Pointer, next unsafe.Pointer) (unsafe.Pointer, error) {
...
func (o PhysicalDeviceExternalFenceOptions) PopulateOutData(cDataPointer unsafe.Pointer, helpers ...any) (next unsafe.Pointer, err error) {
