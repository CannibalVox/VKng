...
func (e *VulkanExtension) DescriptorSetLayoutSupport(device core1_0.Device, setLayoutOptions core1_0.DescriptorSetLayoutOptions, support *DescriptorSetLayoutSupportOutData) error {
