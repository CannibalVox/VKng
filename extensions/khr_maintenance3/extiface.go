...
type Extension interface {
	DescriptorSetLayoutSupport(device core1_0.Device, setLayoutOptions core1_0.DescriptorSetLayoutCreateOptions, support *DescriptorSetLayoutSupportOutData) error
}
