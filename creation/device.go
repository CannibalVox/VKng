...
func populateFeatures(f *C.VkPhysicalDeviceFeatures, enabledFeatures *VKng.PhysicalDeviceFeatures) {
	...
	if enabledFeatures.RobustBufferAccess {  f.robustBufferAccess = C.VK_TRUE}
	if enabledFeatures.FullDrawIndexUint32 {  f.fullDrawIndexUint32 = C.VK_TRUE}
	if enabledFeatures.ImageCubeArray {  f.imageCubeArray = C.VK_TRUE}
	if enabledFeatures.IndependentBlend {  f.independentBlend = C.VK_TRUE}
	if enabledFeatures.GeometryShader {  f.geometryShader = C.VK_TRUE}
	if enabledFeatures.TessellationShader {  f.tessellationShader = C.VK_TRUE}
	if enabledFeatures.SampleRateShading {  f.sampleRateShading = C.VK_TRUE}
	if enabledFeatures.DualSrcBlend {  f.dualSrcBlend = C.VK_TRUE}
	if enabledFeatures.LogicOp {  f.logicOp = C.VK_TRUE}
	if enabledFeatures.MultiDrawIndirect {  f.multiDrawIndirect = C.VK_TRUE}
	if enabledFeatures.DrawIndirectFirstInstance {  f.drawIndirectFirstInstance = C.VK_TRUE}
	if enabledFeatures.DepthClamp {  f.depthClamp = C.VK_TRUE}
	if enabledFeatures.DepthBiasClamp {  f.depthBiasClamp = C.VK_TRUE}
	if enabledFeatures.FillModeNonSolid {  f.fillModeNonSolid = C.VK_TRUE}
	if enabledFeatures.DepthBounds {  f.depthBounds = C.VK_TRUE}
	if enabledFeatures.WideLines {  f.wideLines = C.VK_TRUE}
	if enabledFeatures.LargePoints {  f.largePoints = C.VK_TRUE}
	if enabledFeatures.AlphaToOne {  f.alphaToOne = C.VK_TRUE}
	if enabledFeatures.MultiViewport {  f.multiViewport = C.VK_TRUE}
	if enabledFeatures.SamplerAnisotropy {  f.samplerAnisotropy = C.VK_TRUE}
	if enabledFeatures.TextureCompressionEtc2 {  f.textureCompressionETC2 = C.VK_TRUE}
	if enabledFeatures.TextureCompressionAstcLdc {  f.textureCompressionASTC_LDR = C.VK_TRUE}
	if enabledFeatures.TextureCompressionBc {  f.textureCompressionBC = C.VK_TRUE}
	if enabledFeatures.OcclusionQueryPrecise {  f.occlusionQueryPrecise = C.VK_TRUE}
	if enabledFeatures.PipelineStatisticsQuery {  f.pipelineStatisticsQuery = C.VK_TRUE}
	if enabledFeatures.VertexPipelineStoresAndAtomics {  f.vertexPipelineStoresAndAtomics = C.VK_TRUE}
	if enabledFeatures.FragmentStoresAndAtomics {  f.fragmentStoresAndAtomics = C.VK_TRUE}
	if enabledFeatures.ShaderTessellationAndGeometryPointSize {  f.shaderTessellationAndGeometryPointSize = C.VK_TRUE}
	if enabledFeatures.ShaderImageGatherExtended {  f.shaderImageGatherExtended = C.VK_TRUE}
	if enabledFeatures.ShaderStorageImageExtendedFormats {  f.shaderStorageImageExtendedFormats = C.VK_TRUE}
	if enabledFeatures.ShaderStorageImageMultisample {  f.shaderStorageImageMultisample = C.VK_TRUE}
	if enabledFeatures.ShaderStorageImageReadWithoutFormat {  f.shaderStorageImageReadWithoutFormat = C.VK_TRUE}
	if enabledFeatures.ShaderStorageImageWriteWithoutFormat {  f.shaderStorageImageWriteWithoutFormat = C.VK_TRUE}
	if enabledFeatures.ShaderUniformBufferArrayDynamicIndexing {  f.shaderUniformBufferArrayDynamicIndexing = C.VK_TRUE}
	if enabledFeatures.ShaderSampledImageArrayDynamicIndexing {  f.shaderSampledImageArrayDynamicIndexing = C.VK_TRUE}
	if enabledFeatures.ShaderStorageBufferArrayDynamicIndexing {  f.shaderStorageBufferArrayDynamicIndexing = C.VK_TRUE}
	if enabledFeatures.ShaderStorageImageArrayDynamicIndexing {  f.shaderStorageImageArrayDynamicIndexing = C.VK_TRUE}
	if enabledFeatures.ShaderClipDistance {  f.shaderClipDistance = C.VK_TRUE}
	if enabledFeatures.ShaderCullDistance {  f.shaderCullDistance = C.VK_TRUE}
	if enabledFeatures.ShaderFloat64 {  f.shaderFloat64 = C.VK_TRUE}
	if enabledFeatures.ShaderInt64 {  f.shaderInt64 = C.VK_TRUE}
	if enabledFeatures.ShaderInt16 {  f.shaderInt16 = C.VK_TRUE}
	if enabledFeatures.ShaderResourceResidency {  f.shaderResourceResidency = C.VK_TRUE}
	if enabledFeatures.ShaderResourceMinLod {  f.shaderResourceMinLod = C.VK_TRUE}
	if enabledFeatures.SparseBinding {  f.sparseBinding = C.VK_TRUE}
	if enabledFeatures.SparseResidencyBuffer {  f.sparseResidencyBuffer = C.VK_TRUE}
	if enabledFeatures.SparseResidencyImage2D {  f.sparseResidencyImage2D = C.VK_TRUE}
	if enabledFeatures.SparseResidencyImage3D {  f.sparseResidencyImage3D = C.VK_TRUE}
	if enabledFeatures.SparseResidency2Samples {  f.sparseResidency2Samples = C.VK_TRUE}
	if enabledFeatures.SparseResidency4Samples {  f.sparseResidency4Samples = C.VK_TRUE}
	if enabledFeatures.SparseResidency8Samples {  f.sparseResidency8Samples = C.VK_TRUE}
	if enabledFeatures.SparseResidency16Samples {  f.sparseResidency16Samples = C.VK_TRUE}
	if enabledFeatures.SparseResidencyAliased {  f.sparseResidencyAliased = C.VK_TRUE}
	if enabledFeatures.VariableMultisampleRate {  f.variableMultisampleRate = C.VK_TRUE}
	if enabledFeatures.InheritedQueries {  f.inheritedQueries = C.VK_TRUE}
}
