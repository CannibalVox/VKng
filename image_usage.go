...
const (
	...
	InvocationMaskHuawei ImageUsage = C.VK_IMAGE_USAGE_INVOCATION_MASK_BIT_HUAWEI
	AllUsages ImageUsage = TransferSrc|TransferDest|Sampled|Storage|ColorAttachment|
							...
							FragmentDensityMap|FragmentShadingRateAttachment|InvocationMaskHuawei
)
...
var imageUsageToString = map[ImageUsage]string {
	...
	InvocationMaskHuawei: "Invocation Mask (Huawei)",
}
